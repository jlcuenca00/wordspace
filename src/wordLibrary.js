...
export const wordLibraries=[
 ...
 {id:'spanish',label:'SPANISH',detail:'MONKEYTYPE OFFICIAL'},
 {id:'french',label:'FRENCH',detail:'MONKEYTYPE OFFICIAL'},
 {id:'german',label:'GERMAN',detail:'MONKEYTYPE OFFICIAL'},
 {id:'italian',label:'ITALIAN',detail:'MONKEYTYPE OFFICIAL'},
 {id:'portuguese',label:'PORTUGUESE',detail:'MONKEYTYPE OFFICIAL'}
]
